...
import com.proyecto.BackEnd.Security.Dto.JwtDto;
import com.proyecto.BackEnd.Security.Dto.LoginUsuario;
import com.proyecto.BackEnd.Security.Dto.NuevoUsuario;
...
import com.proyecto.BackEnd.Security.Service.UsuarioService;
import com.proyecto.BackEnd.Security.jwt.JwtProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario,BindingResult bindingResult){
     if(bindingResult.hasErrors())
         return new ResponseEntity(new Mensaje("Usuario y/o contraseña invalido"),HttpStatus.BAD_REQUEST);
